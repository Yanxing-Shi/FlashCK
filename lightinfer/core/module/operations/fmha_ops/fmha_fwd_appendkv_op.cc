#include "lightinfer/core/module/operations/fmha_ops/fmha_fwd_appendkv_op.h"

#include "lightinfer/core/module/kernels/fmha_kernels/fmha_fwd_appendkv_kernel.h"
    ...
    return {
        {"batch",
         {std::make_shared<DimInfo>(TensorSource::Input, 0, dim_idx_0),
          ...
          std::make_shared<DimInfo>(TensorSource::Input, 3, dim_idx_0),
          std::make_shared<DimInfo>(TensorSource::Input, 4, dim_idx_0)}},
        {"seqlen_q", {std::make_shared<DimInfo>(TensorSource::Input, 0, dim_idx_1)}},
        {"seqlen_k",
         {std::make_shared<DimInfo>(TensorSource::Input, 1, dim_idx_1),
          std::make_shared<DimInfo>(TensorSource::Input, 2, dim_idx_1)}},
        {"seqlen_knew",
         {std::make_shared<DimInfo>(TensorSource::Input, 3, dim_idx_1),
          std::make_shared<DimInfo>(TensorSource::Input, 4, dim_idx_1)}},
        {"nhead_q", {std::make_shared<DimInfo>(TensorSource::Input, 0, dim_idx_2)}},
        {"nhead_k",
         {std::make_shared<DimInfo>(TensorSource::Input, 1, dim_idx_2),
          std::make_shared<DimInfo>(TensorSource::Input, 2, dim_idx_2),
          std::make_shared<DimInfo>(TensorSource::Input, 3, dim_idx_2),
          std::make_shared<DimInfo>(TensorSource::Input, 4, dim_idx_2)}},
        {"hdim_q",
         {std::make_shared<DimInfo>(TensorSource::Input, 0, dim_idx_3),
          std::make_shared<DimInfo>(TensorSource::Input, 1, dim_idx_3),
          std::make_shared<DimInfo>(TensorSource::Input, 3, dim_idx_3)}},
        {"hdim_v",
         {std::make_shared<DimInfo>(TensorSource::Input, 3, dim_idx_3),
          std::make_shared<DimInfo>(TensorSource::Input, 4, dim_idx_3)}},
    };
}
