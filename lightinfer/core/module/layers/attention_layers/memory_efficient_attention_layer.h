...
#include "lightinfer/core/module/operations/fmha_ops/fmha_fwd_op.h"

namespace lightinfer {

template<typename T>
class MemoryEfficientAttentionLayer: public Layer {
public:
    MemoryEfficientAttentionLayer(FmhaOperationMode        mode,
                                  int64_t                  q_num_heads,
    ...
    ~MemoryEfficientAttentionLayer() = default;
