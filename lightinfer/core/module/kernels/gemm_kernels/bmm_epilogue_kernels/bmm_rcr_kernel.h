...
#include "lightinfer/core/module/kernels/gemm_kernels/bmm_epilogue_kernels/bmm_common_kernel.h"
...
LIGHTINFER_REGISTER_KERNEL(CK, bmm_rcr, lightinfer::BmmRCRKernel, RCR, _Float16, float, ushort);