...
class GemmRCRKernel: public GemmCommonKernel {
public:
    GemmRCRKernel() = default;
...
LIGHTINFER_REGISTER_KERNEL(CK, gemm_rcr, lightinfer::GemmRCRKernel, RCR, _Float16, float, ushort);
