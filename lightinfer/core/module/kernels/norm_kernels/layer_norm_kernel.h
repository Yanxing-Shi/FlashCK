...
#include "lightinfer/core/module/kernels/norm_kernels/norm_common_kernel.h"
...
LIGHTINFER_REGISTER_KERNEL(CK_TILE, layer_norm, lightinfer::LayerNormKernel, ALL_LAYOUT, _Float16, float, ushort);
