...
public:
    ...
    static void                     SetGlobalContext(const int context_id);
...
private:
    ...
    static std::unordered_map<int, std::shared_ptr<Context>> global_contexts_map_;
    static std::shared_ptr<Context>                          global_context_ptr_;

    // Auto Regression model
    int  beigin_regress_idx_ = -1;
