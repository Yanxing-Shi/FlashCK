...
#define _CREATE_NAMEDTUPLE_GETTERS(dummy1, dummy2, i, name)                                                            \
    auto& get(::std::integral_constant<unsigned, i>)                                                                   \
    {                                                                                                                  \
        return name;                                                                                                   \
    }                                                                                                                  \
    const auto& get(::std::integral_constant<unsigned, i>) const                                                       \
    {                                                                                                                  \
        return name;                                                                                                   \
    }
...
#define MAKE_NAMEDTUPLE_SEQ(members)                                                                                   \
    ...
    auto& get()                                                                                                        \
    {                                                                                                                  \
        return get(::std::integral_constant<unsigned, x>{});                                                           \
    }                                                                                                                  \
    template<unsigned x>                                                                                               \
...
template<typename T>
struct is_namedtuple<T, ::std::enable_if_t<sizeof(T::namedtuple_tag) != 0>>: public ::std::true_type {};
template<typename T>
...
struct is_namedtuple_of_id<T, tag_id, ::std::enable_if_t<tag_id == T::nametuple_tag>>: public ::std::true_type {};
