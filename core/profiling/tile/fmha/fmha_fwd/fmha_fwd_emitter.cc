#include "core/profiling/tile/fmha/fmha_fwd/fmha_fwd_emitter.h"
...
// std::vector<FmhaFwdTileDesc> FmhaFwdEmitter::HeuristicFilter(const std::vector<FmhaFwdTileDesc>& fmha_tile_desc,
//                                                        const FmhaProblem&               fmha_problem) const
// {
// }

// std::vector<FmhaFwdAppendKVTileDesc> FmhaFwdEmitter::HeuristicFilter(const std::vector<FmhaFwdAppendKVTileDesc>& fmha_tile_desc,
//                                                                const FmhaProblem& fmha_problem) const
// {   
// }

// std::vector<FmhaFwdSplitKVCombineTileDesc>
// FmhaFwdEmitter::HeuristicFilter(const std::vector<FmhaFwdSplitKVCombineTileDesc>& fmha_tile_desc,
//                              const FmhaProblem&                             fmha_problem) const
// {
// }
...
std::vector<FmhaFwdCodeGen> FmhaFwdEmitter::CreateInstanceForConfig(const FmhaFwdConfig& config, const FmhaProblem& fmha_problem) {
...
void FmhaFwdEmitter::GenerateInstances(FmhaProblem& fmha_problem)
{
    ...
    for (const auto& config : g_backup_fmha_fwd_config) {
        FmhaFwdCodeGen fmha;
