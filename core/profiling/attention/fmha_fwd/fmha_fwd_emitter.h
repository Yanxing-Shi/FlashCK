...
public:
     ...
     * @param fmha_fwd_problem Problem specification including dimensions and data types
     ...
     * @param fmha_fwd_problem Problem specification for context-aware filtering
     ...
     * @param fmha_fwd_problem The FMHA problem configuration to solve
     * 
     ...
     * @param fmha_fwd_problem The FMHA problem configuration
     * @return Reference to the instance map for the specific FMHA kind
     */
    std::map<std::string, FmhaFwdCodeGen>& GetInstanceMap(FmhaFwdProblem fmha_fwd_problem)
    {
        GenerateInstances(fmha_fwd_problem);
