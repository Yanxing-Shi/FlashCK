...
/**
 * @class FmhaFwdBatchPrefillProblem
 ...
 */
class FmhaFwdBatchPrefillProblem: public ProblemBase<FmhaFwdBatchPrefillProblem> {
public:
    /**
    ...
    {
        return "FmhaFwdBatchPrefillProblem";
    }
    ...
    std::string SerializeImpl()
    {
        ...
        oss << "\"num_total_pages\": " << num_total_pages;
        oss << "}";
        return oss.str();
    }
    ...
    bool has_logits_soft_cap_; ///< Whether to apply soft cap to logits
