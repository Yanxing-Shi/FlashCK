...
public:
    ...
    InstanceData(Environment                                         env,
                ...
                std::variant<legacy::GemmProblem, tile::GemmProblem> problem
                ):
    ...
    std::variant<legacy::GemmProblem, tile::GemmProblem> problem_;  ///< Problem specification (extensible via variant)
