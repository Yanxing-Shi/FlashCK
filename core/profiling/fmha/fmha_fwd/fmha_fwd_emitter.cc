...
bool FmhaFwdEmitter::IsValidTile(const FmhaFwdTileDesc& tile_desc, const FmhaProblem& fmha_problem)
{
...
std::vector<FmhaFwdCodeGen> FmhaFwdEmitter::CreateInstanceForConfig(
    const FmhaFwdConfig& config, const FmhaProblem& fmha_problem) 
{
...
void FmhaFwdEmitter::GenerateInstances(FmhaProblem& fmha_problem)
{
