...
{
    return Sprintf("fmha_batch_prefill_{dtype}_{mode}_{tile_desc}_{pipeline}",
...
using {{name}}  =
    ck_tile::FmhaBatchPrefillWithPagedKVCacheKernel<{{pipeline}}<fmha_pipeline_problem_{{idx}}>,
