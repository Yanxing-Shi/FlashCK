...
class GroupGemmKernel: public GemmCommonKernel {
public:
    GroupGemmKernel()  = default;
    ~GroupGemmKernel() = default;
...
FC_REGISTER_KERNEL(TILE, group_gemm, flashck::GroupGemmKernel, ALL_LAYOUT, FP16, BF16, FP32);
