#include "core/module/kernels/gemm_kernels/legacy/gemm_common_kernel.h"


namespace flashck {


std::string LegacyGemmCommonKernel::GenDimCalculator(const std::shared_ptr<DimInfo>& dim_info, bool is_ptr)
{
...
std::string
LegacyGemmCommonKernel::GenShapeEvalCode(const std::string&                                                  dtype,
...
LegacyGemmCommonKernel::GenGemmCommonKernelProfiler(const std::string&                               model_name,
...
std::string
LegacyGemmCommonKernel::GenGemmCommonKernelFunction(const std::string&                               func_name,
                                              const std::unordered_map<std::string, std::any>& kernel_func_map,
                                              const std::string&                               gemm_flag,
                                              const std::string&                               extra_code,
                                              const int                                        ndims,
