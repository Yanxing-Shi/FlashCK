...
static const std::string g_gemm_multi_d_header_tpl = R"(
    #include "ck_tile/ops/gemm.hpp"
    #include "ck_tile/ops/elementwise/unary_element_wise_operation.hpp"
)";

static const std::string g_gemm_multi_d_create_args_tpl = R"(
...
static const std::string g_gemm_multi_d_arg_parser_tpl = R"(
...
static const std::string g_gemm_multi_d_make_args_tpl = R"(
...
static const std::string g_gemm_multi_d_func_call_tpl = R"(
    {{function_name}}(
...
static const std::string g_gemm_multi_d_func_signature_tpl = R"(
void {{function_name}}(
    void* a_ptr,
    void* b_ptr,
    std::array<void*, DsDataType::size()> ds_ptr,
    void* c_ptr,
    int64_t m,
    int64_t n,
    int64_t k,
...
static const std::string g_gemm_multi_d_tensor_decl_tpl = R"(
