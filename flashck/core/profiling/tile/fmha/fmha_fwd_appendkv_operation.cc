#include "flashck/core/profiling/fmha_fwd_appendkv_operation.h"

#include "flashck/core/utils/jinjia2_utils.h"

namespace flashck {

std::string FmhaAppendKVTileDesc::GetInstanceName()
{
...
std::string FmhaFwdAppendKVOperation::GetInstanceName()
{
    std::ostringstream oss;
