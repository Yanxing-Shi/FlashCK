...
static const std::string g_layer_norm_func_call_tpl = R"(
    {{function_name}}(
...
static const std::string g_layer_norm_func_signature_tpl = R"(
void {{function_name}}(
    void* x_ptr,
    void* x_residual_ptr,
...
static const std::string g_layer_norm_tensor_decl_tpl = R"(
    // host verify
