...
#include "flashck/core/module/layers/attention_layers/fuse_multi_head_attention_layer.h"
...
public:
    ...
    void BuildflashckModel(const FuseMultiHeadAttentionConfigs& configs,
                           ...
                           const std::string&                   test_name    = "")
    {
        ...
        x->SetShape({
            ...
            flashck::DDim(hidden_dim),
        });

        auto attn_layer = std::make_unique<flashck::FuseMultiHeadAttentionLayer<T>>(
