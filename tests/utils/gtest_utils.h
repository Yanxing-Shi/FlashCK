...
#include "lightinfer/core/graph/context.h"
...
protected:
    ...
    int                                  dev_id_ = 0;
    hipStream_t                          stream_;
    std::shared_ptr<lightinfer::Context> context_ptr_;
};
